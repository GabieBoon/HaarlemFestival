...
<?= $this->content('hissubnav'); ?>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-27" role="tabpanel" aria-labelledby="nav-26-tab">

                <table>
                    <?=$this->table->generateTable(26,10,27, "Historic", true, false, $this->languages, $this->historicTickets) ?>
                </table>

            </div>
            <div class="tab-pane fade" id="nav-28" role="tabpanel" aria-labelledby="nav-27-tab">

                <table>
                    <?=$this->table->generateTable(27,10,27, "Historic", true, false, $this->languages, $this->historicTickets) ?>
                </table>

            </div>
            <div class="tab-pane fade" id="nav-29" role="tabpanel" aria-labelledby="nav-28-tab">

                <table>
                    <?=$this->table->generateTable(28,10,27, "Historic", true, false, $this->languages, $this->historicTickets) ?>
                </table>

            </div>
            <div class="tab-pane fade" id="nav-28" role="tabpanel" aria-labelledby="nav-29-tab">

                <table>
                    <?=$this->table->generateTable(29,10,27, "Historic", true, false, $this->languages, $this->historicTickets) ?>
                </table>
